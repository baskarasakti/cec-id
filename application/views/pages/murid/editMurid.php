                ...
                <form role="form">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="name" placeholder="Masukkan Nomor Telepon">
                    </div>
                    <div class="form-group">
                      <label for="email">E-mail</label>
                      <input type="email" class="form-control" id="name" placeholder="Masukkan Alamat E-mail">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="second" disabled="disabled">
                        
                      </select>
                    </div>
                    <div class="form-group">
                      <label for="price">Price</label>
                      <input type="price" class="form-control" id="name" placeholder="Masukkan Price">
                    </div>
                    <div class="form-group">
